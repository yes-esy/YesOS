...
#define IRQ14_HARDDISK_PRIMARY (0x2E) // 硬盘中断

#define ERR_PAGE_P (1 << 0) // 页存在
#define ERR_PAGE_WR (1 << 1) // 读写
#define ERR_PAGE_US (1 << 2) // 用户态

#define ERR_EXT (1 << 0) // 选择子存在
#define ERR_IDT (1 << 1) // IDT
/**
...
#define PIC_OCW2_EOI (1 << 5)               // 0 - 非自动结束中断，1 - 自动结束中断
